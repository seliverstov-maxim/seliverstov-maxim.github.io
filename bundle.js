	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function setInitialState() {
	      ...
	      return {
	        num1: { in_expression: num1, on_pic: null, show_num_on_pic: true },
	        num2: { in_expression: num2, on_pic: null, show_num_on_pic: false },
	    ...
	    value: function onChangeResult(e) {
	      ...
	      state.res.val = this.toInt(e.target.value, null);
	    ...
	    value: function onChangeNum1(e) {
	      ...
	      var state = this.state;
	      state.num1.on_pic = this.toInt(e.target.value, null);
	    ...
	    value: function onChangeNum2(e) {
	      ...
	      var state = this.state;
	      state.num2.on_pic = this.toInt(e.target.value, null);
	    ...
	    key: 'toInt',
	    value: function toInt(resource_val, default_val) {
	...
	var Pic = (function (_React$Component) {
	  ...
	  _createClass(Pic, [{
	    ...
	    value: function renderArrows() {
	      var num1 = this.p_state().num1.in_expression;
	      var num2 = this.p_state().num2.in_expression;

	      this.drawArrow(this.canvas, this.numToPixelX(0), this.numToPixelX(num1));
	      this.drawArrow(this.canvas, this.numToPixelX(num1), this.numToPixelX(num1 + num2));
	    }
	  }, {
	    key: 'drawArrow',
	    value: function drawArrow(canvas, from, to) {
	      var diff = Math.abs(to - from);
	      canvas.path('M ' + (from + 5) + ', 100 A35, 10 0 1, 1 ' + to + ', 95').attr({
	        'fill': 'none',
	        'stroke': '#ED00A2',
	        'stroke-width': 2
	      });

	      canvas.path('M ' + (to - 20) + ' 90 L ' + to + ', 95 L ' + (to - 20) + ' 100').attr({
	        'stroke': '#ED00A2',
	        'fill': '#ED00A2',
	        'stroke-width': 2,
	        'transform': 'rotate(' + this.gradusOfArrow(diff) + ', ' + to + ', 100)'
	      });
	    }
	  }, {
	    key: 'gradusOfArrow',
	    value: function gradusOfArrow(l) {
	      return 15 + Math.round(l / 10);
	    }
	  }, {
	    key: 'numToPixelX',
	    value: function numToPixelX(num) {
	      return Math.round(num * 39);
	    }
	  }, {
	    key: 'numToPixelY',
	    value: function numToPixelY(num) {
	      return 42 - Math.round(num * 5);
	    }
	  }, {
	    key: 'summand1',
	    value: function summand1() {
	      var num1 = this.p_state().num1;
	      if (!num1.show_num_on_pic) {
	        return;
	      }

	      var position_x = Math.round(this.numToPixelX(num1.in_expression) / 2) - 10;
	      var position_y = this.numToPixelY(num1.in_expression);
	      var callback = this.props.onChangeNum1;
	      return this.number(num1.on_pic, num1.in_expression, position_x, position_y, callback);
	    }
	  }, {
	    key: 'summand2',
	    value: function summand2() {
	      var num1 = this.p_state().num1;
	      var num2 = this.p_state().num2;
	      if (!num2.show_num_on_pic) {
	        return;
	      }

	      var num1_pix_shift = this.numToPixelX(num1.in_expression);
	      var num2_pix_shift = Math.round(this.numToPixelX(num2.in_expression) / 2);
	      var position_x = num1_pix_shift + num2_pix_shift - 10;
	      var position_y = this.numToPixelY(num2.in_expression);
	      var callback = this.props.onChangeNum2;
	      return this.number(num2.on_pic, num2.in_expression, position_x, position_y, callback);
	    }
	  }, {
	    key: 'number',
	    value: function number(pic_val, exp_val, position_x, position_y, callback) {
	      var class_name = pic_val != null && pic_val != exp_val ? 'error' : '';
	      var res = exp_val == pic_val ? pic_val : _react2['default'].createElement('input', { value: pic_val, onChange: callback, className: class_name, autoFocus: true });
	      var style = { top: position_y + 'px', left: position_x + 'px' };
	      return _react2['default'].createElement(
	        'span',
	        { className: 'summand', style: style },
	        res
	      );
	    }
	  }, {
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'pic' },
	        _react2['default'].createElement('img', { src: __webpack_require__(161), className: 'ruler' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* { font-family: Georgia, 'Times New Roman', Times, serif; font-size: 36px; font-weight: bold;  }\n.formula { position: relative; top: 50px; left: 50%; margin-left: -50px; }\n.formula input { width: 40px; padding: 0 5px; }\n.formula span { padding: 0 5px; }\n.pic { position: relative; top: -50px; width: 900px; margin: 0 auto; margin-top: 200px; padding-left: 10px; }\n.graph { position: relative; top: -92px; left: 33px; width: 850px; height: 100px; }\n.ruler { position: relative; top: 80px; left: 0; box-shadow: 0px 2px 19px 0px rgba(0, 0, 0, 0.5); border-radius: 10px; }\n.pic .summand { position: absolute; font-size: 36px; font-weight: bold; }\n.pic .summand input { width: 20px; padding: 0 5px; }\n.pic .error { color: #f00; }\n.result.error input { color: #f00; }\n.summand.error { background-color: #ED6F00; }\n\n#app { width: 900px; margin: 0px auto; margin-top: 100px; height: 500px; background-color: rgba(255, 255, 255, 0.8); padding: 20px; border-radius: 25px; z-index: 0; position: relative; box-shadow: 0px 2px 19px 0px rgba(0, 0, 0, 0.5), 0px 2px 4px 0px rgba(0, 0, 0, 0.5); }\n.bg-color { background-image: url(" + __webpack_require__(166) + "); width: 100%; height: 100%; position: absolute; top: 0px; }\n.bg-cells { background-image: url(" + __webpack_require__(167) + "); width: 100%; height: 100%; position: absolute; top: 0px; }\n.bg-stuff { background-image: url(" + __webpack_require__(168) + "); width: 100%; height: 100%; position: absolute; top: 0px; }\n.bg-color2 { background-image: url(" + __webpack_require__(169) + "); width: 100%; height: 100%; position: absolute; top: 0px; z-index: -1;}\n", ""]);
