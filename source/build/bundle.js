...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formulaJsx = __webpack_require__(158);

	var _formulaJsx2 = _interopRequireDefault(_formulaJsx);

	var _picJsx = __webpack_require__(159);

	var _picJsx2 = _interopRequireDefault(_picJsx);
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function setInitialState() {
	      var res = _underscore2['default'].random(11, 14);
	      var num1 = _underscore2['default'].random(6, 9);
	      var num2 = res - num1;
	    ...
	    key: 'onChangeResult',
	    value: function onChangeResult(e) {
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_formulaJsx2['default'], { state: this.state,
	          onChangeResult: this.onChangeResult.bind(this) }),
	        _react2['default'].createElement(_picJsx2['default'], { state: this.state,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Formula = (function (_React$Component) {
	  ...
	  _createClass(Formula, [{
	    ...
	    key: 'summand',
	    value: function summand(num) {
	      var class_name = num.on_pic != null && num.in_expression != num.on_pic ? 'error' : '';
	      return _react2['default'].createElement(
	        'span',
	        { className: 'summand ' + class_name },
	        num.in_expression
	      );
	    }
	  }, {
	    key: 'result',
	    value: function result(num) {
	      var class_name = num.val != null && num.val != num.correct_val ? 'error' : '';

	      if (num.show_input) {
	        var output = _react2['default'].createElement('input', { value: num.val, onChange: this.props.onChangeResult, autoFocus: true });
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _svgJs = __webpack_require__(160);

	var _svgJs2 = _interopRequireDefault(_svgJs);

	var _picFirst_summandJsx = __webpack_require__(161);

	var _picFirst_summandJsx2 = _interopRequireDefault(_picFirst_summandJsx);

	var _picSecond_summandJsx = __webpack_require__(164);

	var _picSecond_summandJsx2 = _interopRequireDefault(_picSecond_summandJsx);

	var _helpersCoordinate_converterJs = __webpack_require__(163);

	var _helpersCoordinate_converterJs2 = _interopRequireDefault(_helpersCoordinate_converterJs);

	var _helpersDraw_helperJs = __webpack_require__(165);

	var _helpersDraw_helperJs2 = _interopRequireDefault(_helpersDraw_helperJs);
	...
	var Pic = (function (_React$Component) {
	  ...
	  function Pic() {
	    ...
	    _get(Object.getPrototypeOf(Pic.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(Pic, [{
	    ...
	    value: function componentDidMount() {
	      this.canvas = (0, _svgJs2['default'])('svg-graph');
	      this.renderArrows();
	    }
	  }, {
	    key: 'renderArrows',
	    value: function renderArrows() {
	      ...
	      _helpersDraw_helperJs2['default'].drawArrow(this.canvas, _helpersCoordinate_converterJs2['default'].numToPixelX(0), _helpersCoordinate_converterJs2['default'].numToPixelX(num1));
	      _helpersDraw_helperJs2['default'].drawArrow(this.canvas, _helpersCoordinate_converterJs2['default'].numToPixelX(num1), _helpersCoordinate_converterJs2['default'].numToPixelX(num1 + num2));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'pic' },
	        _react2['default'].createElement('img', { src: __webpack_require__(166), className: 'ruler' }),
	        _react2['default'].createElement(
	          'div',
	          { className: 'graph' },
	          _react2['default'].createElement('div', { id: 'svg-graph' }),
	          _react2['default'].createElement(_picFirst_summandJsx2['default'], { state: this.p_state(), callback: this.props.onChangeNum1 }),
	          _react2['default'].createElement(_picSecond_summandJsx2['default'], { state: this.p_state(), callback: this.props.onChangeNum2 })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _numberJsx = __webpack_require__(162);

	var _numberJsx2 = _interopRequireDefault(_numberJsx);

	var _helpersCoordinate_converterJs = __webpack_require__(163);

	var _helpersCoordinate_converterJs2 = _interopRequireDefault(_helpersCoordinate_converterJs);

	var FirstSummand = (function (_React$Component) {
	  _inherits(FirstSummand, _React$Component);

	  function FirstSummand() {
	    _classCallCheck(this, FirstSummand);

	    _get(Object.getPrototypeOf(FirstSummand.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(FirstSummand, [{
	    key: 'callback',
	    ...
	    key: 'position',
	    value: function position(num) {
	      var y = _helpersCoordinate_converterJs2['default'].numToPixelY(num.in_expression);
	      var x = Math.round(_helpersCoordinate_converterJs2['default'].numToPixelX(num.in_expression) / 2);
	    ...
	    value: function render() {
	      ...
	      if (!num.show_num_on_pic) {
	        return _react2['default'].createElement('span', null);
	      }

	      return _react2['default'].createElement(_numberJsx2['default'], {
	        pic_val: num.on_pic,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PicNumber = (function (_React$Component) {
	  _inherits(PicNumber, _React$Component);

	  function PicNumber() {
	    _classCallCheck(this, PicNumber);

	    _get(Object.getPrototypeOf(PicNumber.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(PicNumber, [{
	    key: 'pic_val',
	    value: function pic_val() {
	      return this.props.pic_val;
	    }
	  }, {
	    key: 'exp_val',
	    value: function exp_val() {
	      return this.props.exp_val;
	    }
	  }, {
	    key: 'callback',
	    value: function callback() {
	    ...
	    value: function class_name() {
	      if (this.pic_val() == null) {
	        return '';
	      }
	      if (this.pic_val() == this.exp_val()) {
	        return '';
	      }
	    ...
	    value: function result() {
	      if (this.exp_val() == this.pic_val()) {
	        return this.pic_val();
	      }
	      return _react2['default'].createElement('input', { value: this.pic_val(), onChange: this.callback(), autoFocus: true });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'span',
	        { className: 'summand ' + this.class_name(), style: this.style() },
	        this.result()
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var CoordinateConverter = (function () {
	  ...
	  _createClass(CoordinateConverter, null, [{
	    key: "numToPixelX",
	    value: function numToPixelX(val) {
	      return Math.round(val * 39);
	    }
	  }, {
	    key: "numToPixelY",
	    value: function numToPixelY(val) {
	      return 42 - Math.round(val * 6);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SecondSummand = (function (_React$Component) {
	  _inherits(SecondSummand, _React$Component);

	  function SecondSummand() {
	    _classCallCheck(this, SecondSummand);

	    _get(Object.getPrototypeOf(SecondSummand.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(SecondSummand, [{
	    key: 'callback',
	    value: function callback() {
	      return this.props.callback;
	    }
	    ...
	    key: 'position',
	    value: function position(num1, num2) {
	      var num1_pix_shift = _helpersCoordinate_converterJs2['default'].numToPixelX(num1.in_expression);
	      var num2_pix_shift = Math.round(_helpersCoordinate_converterJs2['default'].numToPixelX(num2.in_expression) / 2);

	      var y = _helpersCoordinate_converterJs2['default'].numToPixelY(num2.in_expression);
...
/***/ function(module, exports) {
	...
	var DrawHelper = (function () {
	  ...
	  _createClass(DrawHelper, null, [{
	    key: 'drawArrow',
	    value: function drawArrow(canvas, from, to) {
	      var diff = Math.abs(to - from);
	      var circle_rx = Math.round(Math.pow(diff / 20, 1.5));
	      var circle_ry = Math.round(Math.pow(diff / 40, 1.5));

	      canvas.path('M ' + (from + 5) + ', 100 A' + circle_rx + ', ' + circle_ry + ' 0 0, 1 ' + (to - 5) + ', 100').attr({
	        'fill': 'none',
	        'stroke': '#ED00A2',
	        'stroke-width': 2
	      });
	      ...
	      canvas.path('M ' + (to - 20) + ' 95 L ' + (to - 5) + ', 100 L ' + (to - 20) + ' 105').attr({
	        'stroke': '#ED00A2',
	        'fill': '#ED00A2',
	        'stroke-width': 2,
	        'transform': 'rotate(' + gradusOfArrow + ', ' + (to - 5) + ', 100)'
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html, body { margin: 0; padding: 0}\n* { font-family: Georgia, 'Times New Roman', Times, serif; font-size: 36px; font-weight: bold;  }\n\n.formula { position: relative; top: 80px; margin: 0 auto; height: 50px; line-height: 50px; margin: 0px auto; width: 200px; }\n.formula input { width: 40px; padding: 0 5px; }\n.formula span { padding: 0 5px; }\n.formula .summand.error { background-color: #ED6F00; }\n\n.graph { position: relative; top: -92px; left: 33px; width: 850px; height: 100px; }\n.ruler { position: relative; top: 80px; left: 0; box-shadow: 0px 2px 19px 0px rgba(0, 0, 0, 0.5); border-radius: 10px; }\n\n.pic { position: relative; top: -70px; width: 900px; margin: 0 auto; margin-top: 200px; padding-left: 10px; }\n.pic .summand { position: absolute; font-size: 36px; font-weight: bold; }\n.pic .summand input { width: 25px; padding: 0 5px; }\n.pic .summand.error input { color: #f00; }\n\n.result.error input { color: #f00; }\n\n#app { width: 900px; margin: 0px auto; margin-top: 100px; height: 500px; border: 5px solid #fff; background-color: rgba(242, 238, 238, 0.9); padding: 20px; border-radius: 25px; z-index: 0; position: relative; box-shadow: 0px 2px 19px 0px rgba(0, 0, 0, 0.5), 0px 2px 4px 0px rgba(0, 0, 0, 0.5); }\n.bg-color { background-image: url(" + __webpack_require__(171) + "); width: 100%; height: 100%; position: absolute; top: 0px; }\n.bg-cells { background-image: url(" + __webpack_require__(172) + "); width: 100%; height: 100%; position: absolute; top: 0px; }\n.bg-stuff { background-image: url(" + __webpack_require__(173) + "); width: 100%; height: 100%; position: absolute; top: 0px; }\n.bg-color2 { background-image: url(" + __webpack_require__(174) + "); width: 100%; height: 100%; position: absolute; top: 0px; z-index: -1;}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"

/***/ },
/* 172 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"

/***/ },
/* 173 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "4d90f87a5486bf13b76eab8831a64f19.png"

/***/ },
/* 174 */
/***/ function(module, exports) {

	module.exports = "data:image/jpeg;base64,"
